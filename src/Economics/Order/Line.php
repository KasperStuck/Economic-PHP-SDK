...
class Line {
    ...
    {
        // makes sure the $handles variable will always be an array, no matter how many orderlines
        if (is_object($handles)) {
            $handleData = $handles;
            $handles = [];
            array_push($handles, $handleData);
        }
